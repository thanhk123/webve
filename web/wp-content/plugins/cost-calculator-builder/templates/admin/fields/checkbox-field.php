...
<div class="field-form-wrapper">
    ...
    <div class="field-form-row">
        <div class="form-group large inline">
            <div class="ccb-switch">
                <input type="checkbox" v-model="checkboxField.horizontally_view"/>
                <label></label>
            </div>
            <div class="ccb-switch-label">
    ...
    <div class="field-form-row options">
        ...
        <div class="form-group large inline add-options" v-for="(option, index) in checkboxField.options">
            <div class="options">
            ...
            <div class="options">
                <div class="input-type-number-wrapper">
                    <input :name="'option_' + index" @keyup="removeErrorTip('errorOptionValue' + index)" min="0"
                           placeholder="<?php esc_attr_e('Option Value ...', 'cost-calculator-builder')?>"
                           type="number" step="1" v-model="option.optionValue" required>
    ...
    <div class="field-form-row">
        <div class="form-group large">
            ...
            <textarea placeholder="<?php esc_attr_e( 'Enter your classes', 'cost-calculator-builder' ) ?>" v-model="checkboxField.additionalStyles"></textarea>
        </div>
    </div>
    ...
    <div class="actions">
        <div class="right">
            ...
            <button type="button" class="green" @click.prevent="save(checkboxField, id, index, event)">
