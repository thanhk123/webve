 ...
 */
	...
	public static $conditionStates = [
		[
			...
			'fields' => ['checkbox', 'dropDown', 'radio', 'toggle', 'dropDown_with_img' ] //datePicker
		],
		[
			'title' => 'is equal to', 'value' => '==',
			'fields' => ['multi_range', 'quantity', 'range', 'range_datePicker', 'total', 'file_upload_with_price']
		],
		[
			'title' => 'is inferior to', 'value' => '<=',
			'fields' => [
				'checkbox', 'dropDown', 'dropDown_with_img', 'multi_range', 'quantity', //datePicker
				'radio', 'range', 'range_datePicker','toggle' , 'total', 'file_upload_with_price']
		],
		[
	...
	public static $actions = [
		['title' => 'Show', 'value' => 'show', 'flex_grow' => '0',
		 'fields' => [
			 ...
			 'text', 'toggle', 'total', 'file_upload', 'file_upload_with_price']
		],
		...
		['title' => 'Hide (leave in Total)', 'value' => 'hide_leave_in_total', 'flex_grow' => '0',
		 'fields' => [
			 'checkbox','datePicker','dropDown', 'dropDown_with_img', 'multi_range', 'quantity',
		...
		['title' => 'Unset', 'value' => 'unset', 'flex_grow' => '0',
		 'fields' => ['checkbox','datePicker','dropDown', 'dropDown_with_img', 'quantity', 'radio', 'range_datePicker', 'toggle']
		],
		...
		['title' => 'Select option', 'value' => 'select_option', 'flex_grow' => '1',
		 'fields' => ['checkbox','toggle', 'dropDown', 'dropDown_with_img', 'radio']
		],
