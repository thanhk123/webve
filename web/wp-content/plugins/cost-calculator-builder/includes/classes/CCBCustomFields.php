...
class  CCBCustomFields {
    ...
    {
        return [
            "label"    => $label === null ? "Border" : $label,
            "type"     => 'border',
            "name"     => $name === null ? "border" : $name,
            "default"  => [
    ...
    {
        return [
            "label"    => $label === null ? "Border-radius" : $label,
            "type"     => 'border-radius',
            "name"     => $name === null ? "border-radius" : $name,
            "default"  => [
    ...
    public static function custom_default_styles()
    {
        $data = [
            ...
            "file-upload"   => [
                "file_name_bg_color" => '#73c73b33',//rgba(115, 199, 59, 0.2)
            ],
        ];
