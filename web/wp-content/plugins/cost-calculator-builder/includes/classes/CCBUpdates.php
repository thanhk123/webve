...
class CCBUpdates {
	...
	private static $updates = array(
		...
		'2.2.5' => array(
			'cc_add_custom_styles_to_datepicker',
			'cc_update_all_calculators_condition_actions',
		),
		'2.2.6' => array(
			'cc_create_orders_table',
			'cc_update_calc_settings',
		),
		'2.2.7' => array(
		...
		'2.3.0' => array(
			...
			'cc_add_file_upload_style',
			'cc_style_input_fields_and_buttons',
		),
		'2.3.2' => array( 'ccb_update_payments_table_total_column' ),
	);
