...
class Token extends Tag
{
    ...
    protected function register_controls_settings()
    {
        ...
        $this->add_control('dce_token', ['label' => __('Token', 'dynamic-content-for-elementor'), 'type' => \Elementor\Controls_Manager::TEXT, 'label_block' => \true, 'placeholder' => '[post:title|esc_html], [post:meta_key], [user:display_name], [term:name], [wp_query:posts]', 'condition' => ['dce_token_wizard' => '']]);
        $types = [
