...
point1.setFromMatrixPosition(camera.matrixWorld);var point1=point1.clone();var point2=object.position;var distance=(point1.distanceTo(point2)/distanza)-1;distance=distance*(3*distance);if(animated){gsap.to(object.element,{duration:0.6,webkitFilter:"blur("+distance.toFixed(2)+"px)",filter:"blur("+distance.toFixed(2)+"px)",})}else{gsap.set(object.element,{webkitFilter:"blur("+distance.toFixed(2)+"px)",filter:"blur("+distance.toFixed(2)+"px)",})}}};jQuery(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.3d',Widget_DCE_Dynamicposts_3d_Handler);elementorFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.3d',Widget_DCE_Dynamicposts_3d_Handler);elementorFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-show-favorites.3d',Widget_DCE_Dynamicposts_3d_Handler);elementorFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.3d',Widget_DCE_Dynamicposts_3d_Handler);elementorFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.3d',Widget_DCE_Dynamicposts_3d_Handler);elementorFrontend.hooks.addAction('frontend/element_ready/dce-search-results.3d',Widget_DCE_Dynamicposts_3d_Handler);elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.3d',Widget_DCE_Dynamicposts_3d_Handler)})