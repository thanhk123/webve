...
jQuery(window).on('elementor/frontend/init', function() {
	...
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.3d', Widget_DCE_Dynamicposts_base_Handler);
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.carousel', Widget_DCE_Dynamicposts_base_Handler);
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.crossroadsslideshow', Widget_DCE_Dynamicposts_base_Handler);
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.dualcarousel', Widget_DCE_Dynamicposts_base_Handler);
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.grid-filters', Widget_DCE_Dynamicposts_base_Handler);
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.gridtofullscreen3d', Widget_DCE_Dynamicposts_base_Handler);
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.smoothscroll', Widget_DCE_Dynamicposts_base_Handler);
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.timeline', Widget_DCE_Dynamicposts_base_Handler);
	elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-relationship.grid', Widget_DCE_Dynamicposts_base_Handler);
});
